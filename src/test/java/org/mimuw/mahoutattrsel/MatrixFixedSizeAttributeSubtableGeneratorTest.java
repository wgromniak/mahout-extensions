...
public class MatrixFixedSizeAttributeSubtableGeneratorTest {
    ...
    public void testThreeSubtablesTwoAttributesSeed() throws Exception {
        ...
        MatrixAssert.assertThat(listOfSubtables.get(1).getTable()).isEqualTo(new DenseMatrix(
                new double[][]{{1, 3, 5}, {4, 5, 3}, {5, 2, 3}, {4, 1, 4}, {5, 7, 1}, {4, 21, 3}}));
        ...
        MatrixAssert.assertThat(listOfSubtables.get(2).getTable()).isEqualTo(new DenseMatrix(
    ...
    public void testTwoSubtablesThreeAttributesSeed() throws Exception {
        ...
        MatrixAssert.assertThat(listOfSubtables.get(0).getTable()).isEqualTo(new DenseMatrix(new double[][]
    ...
    public void testFiveSubtablesOneAttribute() throws Exception {
        ...
        List<Subtable> listOfSubtables = matrixUnderTests.getSubtables();
        ...
        MatrixAssert.assertThat(listOfSubtables.get(1).getTable()).isEqualTo(new DenseMatrix(new double[][]
        ...
        MatrixAssert.assertThat(listOfSubtables.get(2).getTable()).isEqualTo(new DenseMatrix(new double[][]
        ...
        MatrixAssert.assertThat(listOfSubtables.get(3).getTable()).isEqualTo(new DenseMatrix(new double[][]
                {{3, 2}, {2, 4}, {4, 2}, {3, 1}, {2, 1}, {5, 5}}));
        ...
        MatrixAssert.assertThat(listOfSubtables.get(4).getTable()).isEqualTo(new DenseMatrix(new double[][]
                {{3, 2}, {2, 4}, {4, 2}, {3, 1}, {2, 1}, {5, 5}}));
